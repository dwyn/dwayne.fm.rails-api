...
exports.prefixPathFormatter = undefined;
exports.createPaginationPages = createPaginationPages;
exports.createLinkedPages = createLinkedPages;

var _paginationPageBuilder = require("./pagination-page-builder");

var _paginationPageBuilder2 = _interopRequireDefault(_paginationPageBuilder);

var _linkedPageBuilder = require("./linked-page-builder");

var _linkedPageBuilder2 = _interopRequireDefault(_linkedPageBuilder);
 ...
 * });
 */
function createPaginationPages(props) {
  var createPage = props.createPage,
      edges = props.edges,
      component = props.component,
      layout = props.layout,
      limit = props.limit,
      pathFormatter = props.pathFormatter,
      context = props.context;

  var paginationPageBuilder = new _paginationPageBuilder2.default(createPage, edges, component, layout);
 ...
 * });
 */
var prefixPathFormatter = exports.prefixPathFormatter = function prefixPathFormatter(prefix) {
  return function (pageNumber) {
    return "" + prefix + (0, _constants.DEFAULT_PATH_FORMATTER)(pageNumber);
  };
};
 ...
 * });
 */
function createLinkedPages(props) {
  var createPage = props.createPage,
      edges = props.edges,
      component = props.component,
      edgeParser = props.edgeParser,
      circular = props.circular;

  var linkedPageBuilder = new _linkedPageBuilder2.default(createPage, edges, component, edgeParser);
